...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <div class="mt-5 md:col-span-2 md:mt-0">
      <form action="/management/mgtproducts/" enctype="multipart/form-data"  method="POST">
        @csrf
        <div class="shadow-lg sm:overflow-hidden sm:rounded-md">
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            ...
            <label for="company-website" class="block text-sm font-medium text-gray-700">Cost</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  <input type="number" name="cost" id="company-website" class="mt-4 block w-full flex-1 rounded-none rounded-r-md border-black-500
                  focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
            </div>

            <div>
            <label for="company-website" class="block text-sm font-medium text-gray-700">Table_no</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  <input type="number" name="Table_no" id="company-website" class="mt-4 block w-full flex-1 rounded-none rounded-r-md border-black-500
                  focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
            </div>

            <div>
              <label for="company-website" class="block text-sm font-medium text-gray-700" id="menu-button" aria-expanded="true" aria-haspopup="true">Category</label>
              <div class="mt-1 flex rounded-md shadow-lg text-black">
                <select name="restaurant_id" id="company-website" class="mt-4 block w-full flex-1 rounded-none rounded-r-md border-black-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
