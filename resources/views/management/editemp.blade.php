      ...
      <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
        <nav aria-label="Sidebar" class="sticky top-4 divide-y divide-gray-300">
              <div class="space-y-1 pb-8">
                <a href="/management" class="bg-gray-200 text-gray-900 group flex items-center rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6 ml-96">
    ...
    <div class="mt-5 md:col-span-2 md:mt-0">
      ...
      <form action="/management/employee/{{ $employee->id }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="shadow-lg sm:overflow-hidden sm:rounded-md">
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  ...
                  <input type="text" name="name" value="{{$employee->name}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
              </div>
            </div>

            <div>
            <label for="company-website" class="block text-sm font-medium text-gray-700">Availability</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">

                  <input type="text" name="availability" value="{{$employee->availability}}"
            ...
            <div>
            <label for="company-website" class="block text-sm font-medium text-gray-700">Occupation</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">

                  <input type="text" name="occupation" value="{{$employee->occupation}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
