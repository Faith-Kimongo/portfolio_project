...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6 ml-96">
    ...
    <div class="mt-5 md:col-span-2 md:mt-0">
      ...
      <form action="/management/table/{{ $table->id }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="shadow-lg sm:overflow-hidden sm:rounded-md">
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  ...
                  <input type="text" name="name" value="{{$table->name}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
              </div>
            </div>

            <div>
            <label for="company-website" class="block text-sm font-medium text-gray-700">Number</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
            ...
            <div>
            <label for="company-website" class="block text-sm font-medium text-gray-700">Occupants</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">

                  <input type="text" name="occupants" value="{{$table->occupants}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
