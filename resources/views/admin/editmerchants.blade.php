...
<div>
  <div class="md:grid md:grid-cols-3 md:gap-6 ml-96">
    ...
    <div class="mt-5 md:col-span-2 md:mt-0">
      ...
      <form action="/admin/merchants/{{ $merchants->id }}" enctype="multipart/form-data" method="POST">
        @csrf
          ...
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  ...
                  <input type="text" name="name" value="{{$merchants->name}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
              </div>
            </div>
            ...
            <label for="company-website" class="block text-sm font-medium text-gray-700">Email</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  ...
                  <input type="text" name="email" value="{{$merchants->email}}"
            ...
            <label for="company-website" class="block text-sm font-medium text-gray-700">Phone</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  ...
                  <input type="text" name="phone" value="{{$merchants->phone}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
            ...
            <label for="company-website" class="block text-sm font-medium text-gray-700">Location</label>
                <div class="mt-1 flex rounded-md shadow-lg text-black ">
                  ...
                  <input type="text" name="location" value="{{$merchants->location}}" id="company-website" class="block w-full flex-1 rounded-none rounded-r-md border-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" > 
                </div>
